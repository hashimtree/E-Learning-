...
public class SecondActivity extends Activity {
   ...
   {"Nervous Tissue except","Not Excitable","Transmits electrical signals","Can send and receive electrochemical signals","Meylin is insulator"},
   {"cells of Nervous Tissue","Neuroglia transmits signals","Mainly formed of neurons and neuroglia","Neuroglia supporting neurons","Action Potentials propagate information in neurons"},
   ...
   {"muscles except","Are a type of Connective Tissue","Excitable","Contractile","Help movement"},
   {"types muscular tissue  except","Connective Tissue","Cardiac muscles", "Smooth muscles","Skeletal muscles"},
   {"Body Tissues except","Sensory Neurons transmit motor impulse","Motor Neurons signal to move muscles","Smooth muscles are involuntary","Skeletal muscles are voluntarily"},
   {"types of Neurons except","Unipolar neurons have two a ons","Bipolar Neurons have the cell body between the axons","Pseudounipolar found in sensory Neurons","Multipolar Neurons found in motor nerves"},
  {"about synapse except","Is a Connective Tissue","Is a gap Found between two nerves or a nerve and its target ","Neurotransmitters released in it","Neurotransmitters help transmit signals"}, 
   
   {"about muscle tissues except","Smooth muscles attached to bone","Cardiac muscle is involuntary","Smooth muscles found in intestines","Skeletal muscles are voluntary and attached to bones"},
   {"about Neurons except","Myelin in central  nervous system is produced by Astrocytes","Schwann Cells produce myelin on Peripheral Nerves","Astrocytes form the blood brain barrier to protect the brain","Oligodendrocytes produce myelin which is an insulator"},
   {"about synaptic transmission except","Postsynaptic Neurons send the signals to the Presynaptic neurons","Signal starts in Presynaptic neuron","Neurotransmitters are chemicals","Action Potential is produced by enough stimulation and help sending signals between nerves"}
